...
namespace Flexalon
{
    ...
    public class FlexalonCircleLayout : LayoutBase
    {
        ...
        // If set to Evenly, the space around the circle is distributed between children.
        // If set to Fixed, the Spacing Degrees property determines the space between children.
        [SerializeField]
        ...
        public enum RadiusOptions
        {
            ...
            // The radius is incremented for each child by the Radius Step property.
            // This can be used to create an inward or outward spiral.
            Step,

            // If set to Wrap, the radius is incremented each time around the circle.
        ...
        // None, In to the circle, Out of the circle, Forward along the circle,
        // or Backwards along the circle.
        [SerializeField]
        ...
        // Vertically aligns the layout with the height set by the Flexalon Object Component.
